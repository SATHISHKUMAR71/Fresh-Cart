package com.example.shoppinggroceryapp.views.userviews
...
import com.example.shoppinggroceryapp.views.appfragments.orderfragments.OrderSummaryFragment
...
//        val discountedAmount = view.findViewById<TextView>(R.id.priceDetailsDiscountedAmount)
        ...
        cartViewModel = ViewModelProvider(this,CartViewModelFactory(AppDatabase.getAppDatabase(requireContext()).getUserDao()))[CartViewModel::class.java]
