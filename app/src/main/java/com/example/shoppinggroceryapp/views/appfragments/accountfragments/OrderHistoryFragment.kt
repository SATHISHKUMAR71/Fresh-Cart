package com.example.shoppinggroceryapp.views.appfragments.accountfragments
...
class OrderHistoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        noSubscriptionButton.setOnClickListener {
            ...
            com.example.shoppinggroceryapp.views.FragmentTransaction.navigateWithBackstack(parentFragmentManager,orderListFragment,"No Subscription Fragment")
        }
        ...
        dailySubscription.setOnClickListener {
            ...
            orderListFragment.arguments = bundle
            com.example.shoppinggroceryapp.views.FragmentTransaction.navigateWithBackstack(parentFragmentManager,orderListFragment,"Daily Fragment")
        }
        weeklySubscription.setOnClickListener {
            bundle.putString("subscriptionType","Weekly Once")
            println("ON ORDER LIST CLICKBLE $bundle")
            orderListFragment.arguments = bundle
            com.example.shoppinggroceryapp.views.FragmentTransaction.navigateWithBackstack(parentFragmentManager,orderListFragment,"Weekly Fragment")
        }
        monthlySubscription.setOnClickListener {
            bundle.putString("subscriptionType","Monthly Once")
            println("ON ORDER LIST CLICKBLE $bundle")
            orderListFragment.arguments = bundle
            com.example.shoppinggroceryapp.views.FragmentTransaction.navigateWithBackstack(parentFragmentManager,orderListFragment,"Monthly Fragment")
        }
